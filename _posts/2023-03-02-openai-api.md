...
There are many interesting use cases. Through this API, I can see both the multimodal and large language models. It is suprising to see the embedding, NLP tasks, fine-tuning, and more. The [classification](https://github.com/openai/openai-cookbook/blob/main/examples/Fine-tuned_classification.ipynb) example is really shocking. It shows a possibility--a general-purpose ML model purely composed by OpenAI elements and various data formats--numerical features as text, text, audio, video, whatever data format you have. Feed them into GPT, get the embeddings, or more directly, the desired labels. Labels may not even be important. When you ask the system, for example, what's the recommended movie, it will answer you in natural language. We don't need to go deep into the coding and mathematical abstractions. Everything exists in the form of human-understandable language/information. 
